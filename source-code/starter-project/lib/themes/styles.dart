...
class AppThemeStyles {
  ...
  const AppThemeStyles({
    ...
    this.buttonSmall = const ButtonStyle(
      ...
      padding: WidgetStatePropertyAll(EdgeInsets.symmetric(vertical: 4, horizontal: 12)),
    ...
    this.buttonMedium = const ButtonStyle(
      minimumSize: WidgetStatePropertyAll(Size.zero),
      padding: WidgetStatePropertyAll(EdgeInsets.symmetric(vertical: 8, horizontal: 24)),
      shape: WidgetStatePropertyAll(
